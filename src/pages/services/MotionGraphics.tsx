...
import { Layers, Users, TrendingUp, Clock, Star, CheckCircle, ArrowRight, Zap, Target, Award, BarChart3, Shield, Headphones, Calendar, Play, Sparkles } from "lucide-react";
        ...
        <div className="container mx-auto px-6 py-12">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-black max-w-3xl mx-auto leading-relaxed mb-8">
              Dynamic visuals that captivate and convert. Our Motion Graphics service has created 
              <span className="font-semibold text-black"> 18M+ views</span> and 
              <span className="font-semibold text-black"> $2.1M+ in conversions</span> for our clients. 
              Let us animate your vision into reality.
            </p>
          ...
          >
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-black mb-6">Proven Motion Graphics Results</h2>
          ...
          >
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-black mb-6">Our Motion Graphics in Action</h2>
              <p className="text-lg text-black max-w-3xl mx-auto">
                Watch our dynamic motion graphics that have generated millions of views and conversions for our clients.
              </p>
            </div>
          ...
          >
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-black mb-6">Our Motion Graphics Mastery</h2>
              <p className="text-lg text-black max-w-3xl mx-auto">
                We don't just animate graphics—we create dynamic visual experiences that engage audiences and drive results.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                {
                  icon: Target,
                  title: "Strategic Animation",
                  description: "We create motion graphics that align with your brand strategy and drive specific business outcomes.",
                  features: ["Brand-aligned animations", "Strategic storytelling", "Audience engagement", "Conversion optimization"],
                  color: "text-red-600",
                  bgColor: "bg-red-50"
                },
                {
                  ...
                  description: "Cutting-edge animation techniques with smooth, professional motion that captivates viewers.",
                  features: ["Advanced animation techniques", "Smooth motion design", "Professional transitions", "Technical precision"],
                  color: "text-red-600",
                  bgColor: "bg-red-50"
                },
                {
                  ...
                  description: "Unique, eye-catching designs that stand out from the competition and create memorable experiences.",
                  features: ["Creative concept development", "Unique visual styles", "Innovative techniques", "Memorable experiences"],
                  color: "text-red-600",
                  bgColor: "bg-red-50"
                }
              ].map((service, index) => (
          ...
          >
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-black max-w-3xl mx-auto">
                Real results from real clients. See how we've brought their ideas to life.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  role: "SaaS Company",
                  avatar: "TI",
                  quote: "Black Cord Production's motion graphics have transformed our product demos. Their animations increased our conversion rate by 180% and helped us secure $3M in Series A funding.",
                  metrics: [
                    { label: "Conversion Rate", value: "180%" },
                    { label: "Funding Secured", value: "$3M" },
                    { label: "Demo Engagement", value: "250%" }
                  ]
                },
                {
                  ...
                  avatar: "CS",
                  quote: "The quality of their motion graphics is exceptional. Our client campaigns now see 300% higher engagement rates and our agency has grown 200% since partnering with them.",
                  metrics: [
                    { label: "Engagement Rate", value: "300%" },
                    { label: "Agency Growth", value: "200%" },
                ...
                >
                  <Card className="bg-white border border-red-200 p-8 h-full">
                    <div className="flex items-start gap-6">
                      <div className="w-16 h-16 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-2xl flex items-center justify-center text-white font-bold text-xl flex-shrink-0">
                        {client.avatar}
                      </div>
          ...
          >
            <div className="bg-gradient-to-r from-red-50 to-red-100 rounded-3xl p-12 border border-red-200">
              <h2 className="text-4xl font-bold text-black mb-6">Ready to Bring Your Ideas to Life?</h2>
              <p className="text-xl text-black mb-8 max-w-3xl mx-auto">
                Join 150+ brands who trust us with their motion graphics needs. 
                Let's discuss how we can animate your vision into reality.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/start-project">
                  <Button variant="member" size="xl" className="px-8 py-4 text-lg font-semibold">
