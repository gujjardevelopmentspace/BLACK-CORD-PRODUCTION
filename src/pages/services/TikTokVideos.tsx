...
import { Smartphone, Users, TrendingUp, Clock, Star, CheckCircle, ArrowRight, Zap, Target, Award, BarChart3, Shield, Headphones, Calendar, Music, Heart } from "lucide-react";
        ...
        <div className="container mx-auto px-6 py-12">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-black max-w-3xl mx-auto leading-relaxed mb-8">
              We're TikTok's secret weapon. Our viral video service has generated 
              <span className="font-semibold text-black"> 28M+ views</span> and 
              <span className="font-semibold text-black"> 1.8M+ followers</span> for our clients. 
              Let us engineer your content for maximum viral potential.
            </p>
          ...
          >
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-black mb-6">Proven TikTok Results</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
              {[
                ...
                { 
                  ...
                  color: "text-red-600",
                  bgColor: "bg-red-50",
                  description: "Average 92% engagement rate"
                },
                { 
                  number: "92%", 
          ...
          >
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-black mb-6">Our TikTok Videos in Action</h2>
              <p className="text-lg text-black max-w-3xl mx-auto">
                Watch our viral TikTok videos that have generated millions of views and followers for our clients.
              </p>
            </div>
                ...
                <Card className="bg-white border border-red-200 overflow-hidden group hover:shadow-xl transition-all duration-300 h-full flex flex-col">
                  <div className="aspect-[9/16] bg-black relative">
                    <iframe
                      ...
                      src="https://www.tiktok.com/embed/v2/example1"
                      title="TikTok Video - Viral Example 1"
                      frameBorder="0"
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <div className="flex justify-between items-center mt-auto">
                      ...
                      <span className="text-sm text-black">94% engagement</span>
                    </div>
                  </div>
                </Card>
              </motion.div>
              ...
              >
                <Card className="bg-white border border-red-200 overflow-hidden group hover:shadow-xl transition-all duration-300 h-full flex flex-col">
                  <div className="aspect-[9/16] bg-black relative">
                    <iframe
                      className="w-full h-full"
                      src="https://www.tiktok.com/embed/v2/example2"
                      title="TikTok Video - Viral Example 2"
                      frameBorder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                      allowFullScreen
                    ></iframe>
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <div className="flex justify-between items-center mt-auto">
                      <span className="text-red-600 font-semibold">TikTok</span>
                      <span className="text-sm text-black">91% engagement</span>
                    </div>
                  </div>
                </Card>
              </motion.div>
              ...
              >
                <Card className="bg-white border border-red-200 overflow-hidden group hover:shadow-xl transition-all duration-300 h-full flex flex-col">
                  <div className="aspect-[9/16] bg-black relative">
                    <iframe
                      className="w-full h-full"
                      src="https://www.tiktok.com/embed/v2/example3"
                      title="TikTok Video - Viral Example 3"
                      frameBorder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                      allowFullScreen
                    ></iframe>
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <div className="flex justify-between items-center mt-auto">
                      <span className="text-red-600 font-semibold">TikTok</span>
                      <span className="text-sm text-black">96% engagement</span>
                    </div>
                  </div>
                </Card>
              </motion.div>
          ...
          >
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-black mb-6">Our TikTok Mastery Process</h2>
              <p className="text-lg text-black max-w-3xl mx-auto">
                We don't just edit videos—we engineer viral content using proven TikTok strategies and cutting-edge technology.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: "We monitor TikTok trends 24/7 and integrate the hottest sounds, effects, and formats into your content.",
                  features: ["Real-time trend monitoring", "Sound & music integration", "Effect & filter optimization", "Format adaptation"],
                  color: "text-red-600",
                  bgColor: "bg-red-50"
                },
                {
          ...
          >
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-black max-w-3xl mx-auto">
                Real results from real clients. See how we've transformed their TikTok presence.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  avatar: "MR",
                  quote: "Black Cord Production took my TikTok from 5K to 2M followers in just 4 months. Their viral strategies are incredible—my videos now consistently hit the For You page!",
                  metrics: [
                    { label: "Followers Gained", value: "1.995M+" },
                    { label: "Total Views", value: "50M+" },
                    { label: "Brand Deals", value: "15x" }
                  ]
                },
                {
                  name: "Emma Thompson",
                  role: "Beauty Creator",
                  avatar: "ET",
                  quote: "The ROI on their TikTok service is insane. I've seen a 400% increase in engagement and my product launches now sell out in hours. They understand TikTok better than anyone.",
                  metrics: [
                    { label: "Followers Gained", value: "850K+" },
                ...
                >
                  <Card className="bg-white border border-red-200 p-8 h-full">
                    <div className="flex items-start gap-6">
                      <div className="w-16 h-16 bg-gradient-to-br from-pink-500 to-pink-600 rounded-2xl flex items-center justify-center text-white font-bold text-xl flex-shrink-0">
                        {client.avatar}
                      </div>
          ...
          >
            <div className="bg-gradient-to-r from-red-50 to-red-100 rounded-3xl p-12 border border-red-200">
              <h2 className="text-4xl font-bold text-black mb-6">Ready to Dominate TikTok?</h2>
              <p className="text-xl text-black mb-8 max-w-3xl mx-auto">
                Join 300+ creators who trust us with their TikTok growth. 
